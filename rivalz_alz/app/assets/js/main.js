...
(function ($) {
  $(document).ready(function () {
    ...
    if  ($("body").is(".pg_ptype")){
      $("#part_type_donation_level_input_container input[type=radio]").on(
        "change",
        function() {
          -1 !== this.value && $("input[id*=fr_donation_level_enter_amount_]").val("");
        }
      );
    }      
    ...
    if ($('body').is('.pg_personal')) {
      ...
      $('#sidebar_donate_button').html('Donate');
        ...
        $('#personalpage-top-buttons').append( $('#personal_sidebar_donate_button') );
        $('#personalpage-top-buttons').append( $('#personal_sidebar_join_team_button') );
        $('#personalpage-top-buttons').append( $('#personal_team_store_button'));
        // Move personal image
  if ($('#personal_page_image_div').length > 0) {
        ...
        $('#personal_page_image_div').insertBefore('#personalpage-title-block');
        ...
        // move buttons
        $('#personalpage-top-buttons').appendTo( $('#personalpage-top-progress') );
 ...
 console.log($('.team-roster-title-container').closest('.tr-status-indicator-container'));
       ...
       $('#team_page_team_name').after($ ('#join_team_button_container') );
        ...
        // Move Custom Therm
        $('#custom-team-status-container').insertAfter('#team_page_team_name');

       // Move Donate Button
       $('#join_team_button_container').prepend($ ('#join_team_button') );
       $('#join_team_button_container').prepend($ ('#sidebar_donate_button') );
      //  $('#join_team_button_container').append($ ('#team_store_button') );
       ...
       // Add Team Header
       $('#fr_rich_text_container').prepend('<h3>About Our Team</h3>');
