                        ...
                        success: function(response) {
                          ...
                          if(!getPersonalPageResponse) {
                            ...
                            adarda.trpc.ui.fbCreateFundraiser({
                              ...
                              fundraiserName: adarda.trpc.cons.profile.name.first.substring(0, 39) + ' is Taking the Field to End Alzheimer\'s!', 
        ...
        callback: {
          ...
          success: function(response) {
            ...
            if(!createAndLinkFacebookFundraiserResponse || !createAndLinkFacebookFundraiserResponse.fundraiserId) {
              ...
              $('.js__btn-fbf').attr('href', 'https://www.facebook.com/donate/' + fundraiserId).attr('target', '_blank').html('View on Facebook');
        ...
        callback: {
          ...
          success: function(response) {
            ...
            if(confirmOrUnlinkFacebookFundraiserResponse && confirmOrUnlinkFacebookFundraiserResponse.active === 'false') {
              /* not active */
              $('.js__btn-fbf').attr('href','').attr('target','').removeAttr('disabled').html('Connect to Facebook');
            } else {
              /* active */
